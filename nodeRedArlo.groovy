...
metadata {
    definition (
	    ...
	    importUrl:"https://raw.githubusercontent.com/thebearmay/hubitat/main/nodeRedArlo.groovy"
	) 
    {
        	capability "Actuator"
        	capability "Switch"
...
preferences {
    ...
    input("captureLength","number",title: "Number of Seconds to Capture Video (default:60)")
}

def installed() {
	log.trace "installed()"
    device.updateSetting("captureLength",[value:60,type:"number"])
    on()
}
