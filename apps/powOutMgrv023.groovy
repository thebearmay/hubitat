...
void pollDevices(){
    ...
    triggerDevs.each { dev ->
        ...
        if(dev.currentValue("powerSource") == "mains" || dev.currentValue("presence") == "present"|| evt.value.toString().trim() == "online"){
                ...
                state.onBattery = batteryTemp
        } else if(dev.currentValue("powerSource") == "battery" || dev.currentValue("presence") == "not present" || evt.value.toString().trim() == "offline"){
