 ...
 *    08Aug2024                  v2.0.7 add backup option
 *
 */
...
preferences {
    ...
    input("updMesh","bool", title: "Push Update Request to All HubMeshed Hubs")
	  input("makeBkup","bool", title: "Make Backup Before Update")
...
def push(){
	...
	if(makeBkup) {
		updateAttr ("msg", "Backup in Progress")
		httpGet("http://127.0.0.1:8080/hub/backupDB?fileName=latest") {}
	}
