...
*/
    ...
    if(cOrF == "F") {
        ...
        devDetail.hspHome = celsiusToFahrenheit(devDetail.hspSched.toFloat()).toFloat().round(1)
        devDetail.cspHome = celsiusToFahrenheit(devDetail.cspSched.toFloat()).toFloat().round(1)
