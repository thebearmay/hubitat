...
def formatAttrib(){ 
    ...
    if(device.currentValue("cpu5Min")) addToAttr("CPU 5min %","cpu5Min")
...
def getTemp(){
    ...
    // get Free JVM
    //http://hubip/hub/advanced/freeOSMemoryLast
