...
void jsonUpdate(String jsonString){
    ...
    formatUptime(uptime)
    updateAttr("memUsed", nrData.mem.used,"MB")
    updateAttr("memFree", nrData.mem.free,"MB")
    updateAttr("swapUsed", nrData.mem.swapused,"MB")
    updateAttr("swapFree", nrData.mem.swapfree,"MB")
